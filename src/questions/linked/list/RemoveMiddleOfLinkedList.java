...
/**
 * <div class="px-5 pt-4"><div class="_1l1MA"><p>You are given the <code>head</code> of a linked list. <strong>Delete</strong> the <strong>middle node</strong>, and return <em>the</em> <code>head</code> <em>of the modified linked list</em>.</p>
 *
...
public class RemoveMiddleOfLinkedList {
    public ListNode deleteMiddle(ListNode head) {
        ...
        ListNode mid = identifyMiddle(head);
        deleteNextNode(mid);
        return head;
    }
    ...
    private static void deleteNextNode(ListNode node){
